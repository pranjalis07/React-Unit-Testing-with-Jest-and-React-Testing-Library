...
//if we not wrapped the component in browser router we will get error while using link in todoFoter component
// In index.tsx we have used only app inside browser router 
const MockTodoFooter = ({ numberOfIncompleteTasks }: { numberOfIncompleteTasks: number }) => {
    return (
        <BrowserRouter>
          <TodoFooter 
